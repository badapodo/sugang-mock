class ReportExporter:
    ...
    def export_analysis_reports(self, context, analysis):
        ...
        self._summary(report_dir / "summary_report.md", context, analysis)
    ...
    def _prerequisite(self, path, metric):
        ...
        lines.extend(["", "![Prerequisite graph](../charts/prerequisite_graph.png)"])
